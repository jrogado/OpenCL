...
public class SimpleMandelbrot
{
    ...
    public static void main(String args[])
    {
        SwingUtilities.invokeLater(new Runnable()
        {
            public void run()
            {
                ...
                new SimpleMandelbrot(X, Y);
                long stopTime = System.currentTimeMillis();
                System.out.println("Generating a " + X + " by " + Y + " Fractal took " + (stopTime - startTime) + " ms");
            }
        });
    }
    ...
    private void initCL()
    {
        ...
        // Program Setup
        String source = readFile("D:\\Dropbox\\Ensino\\Projects\\IdeaProjects\\OpenCL\\out\\production\\SimpleMandelbrot\\SimpleMandelbrot.cl");
